modelsDataDict = {'ARG': {'Country': 'Argentina',
 ...
 'EST': {'Country': 'Estonia',
         ...
         'UC': 'A.dec_locl B.cur C.cur D.dec E.cur F.cur G.cur_ro H.cur I.dec '
               ...
               'IJ.cur Eng OE.cur Thorn Germandbls',
         'YEXT': 500,
         'lc': 'a.mod b.mlp c.mod d.lop_cu e.ful f.mlp g.jmc h.lop i.mod '
               'j.jmc k.lop l.lop m.mod n.mod o.mlp p.mrr q.jmc r.mlp s.mlp '
               't.lop_ee u.mod v.mlp w.mlp x.cnt y.jmc z.mod ae.ful eth.mod '
               'ij.jmc eng oe.ful thorn.jmc germandbls.jmc idotless.mod '
               'jdotless.jmc ',
         'slnt': 15},
 ...
 'FRA_Traditional': {'Country': 'France',
                     ...
                     'lc': 'a.mod b.lop c.mod d.mod e.ful f.mrr g.jmc h.lop '
                           ...
                           'y.jmc z.cnt ae.ful eth.mod ij.jmc eng oe.ful '
                           'thorn.jmc germandbls.jmc idotless.mod '
                           'jdotless.jmc ',
                     'slnt': 0},
 ...
 'ITA_Traditional': {'Country': 'Italy',
                     ...
                     'lc': 'a.mod b.lop c.mod d.mod e.ful f.ful_de g.jmc h.lop '
                           ...
                           'y.jmc z.mod ae.ful eth.mod ij.jmc eng oe.ful '
                           'thorn.jmc germandbls.jmc idotless.mod '
                           'jdotless.jmc ',
                     'slnt': 0},
 'MEX': {'Country': 'Mexico',

...
<details><summary><b>[17] PlaypenARG[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking file is named canonically. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/canonical_filename">com.google.fonts/check/canonical_filename</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenARG[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2 sTypoAscender (1508) and hhea ascent (1275) must be equal. [code: ascender]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenARG-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'cnct.cnt_G_z' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 0 start point differs in glyph 'cnct.jmc_g_n' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab7b50> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x112ab70d0> [code: interpolation-issues]
...
* ⚠ **WARN** OS/2 xAvgCharWidth is 647 but it should be 690 which corresponds to the average of the widths of all glyphs in the font. [code: xAvgCharWidth-wrong]

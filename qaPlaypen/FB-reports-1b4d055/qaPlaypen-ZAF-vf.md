...
<details><summary><b>[19] PlaypenZAF[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking file is named canonically. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/canonical_filename">com.google.fonts/check/canonical_filename</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenZAF[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1474, but got 1458 instead [code: ascent]
...
angle calculated from outlines: -10.4) [code: positive]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenZAF-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40>

	- Contour 0 start point differs in glyph 'cnct.cnt_G_z' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170be7d0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1170bcf40> [code: interpolation-issues]

...
<details><summary><b>[18] PlaypenHRV[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking file is named canonically. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/canonical_filename">com.google.fonts/check/canonical_filename</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenHRV[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1352, but got 1318 instead [code: ascent]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenHRV-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60>

	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60>

	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bf490> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x1116bdc60> [code: interpolation-issues]

...
<details><summary><b>[18] PlaypenDEUGrundschrift[wght].ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Ensure soft_dotted characters lose their dot when combined with marks that replace the dot. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/<Section: Shaping Checks>.html#com.google.fonts/check/soft_dotted">com.google.fonts/check/soft_dotted</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenDEUGrundschrift[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1393, but got 1365 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 626, but got 445 instead [code: descent]
...
>
* 🔥 **FAIL** OS/2 sTypoAscender (1330) and hhea ascent (1275) must be equal. [code: ascender]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenDEUGrundschrift-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510>

	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510>

	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127efe0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x11127d510> [code: interpolation-issues]
...
* ⚠ **WARN** OS/2 xAvgCharWidth is 647 but it should be 657 which corresponds to the average of the widths of all glyphs in the font. [code: xAvgCharWidth-wrong]

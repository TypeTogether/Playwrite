...
<details><summary><b>[18] PlaypenDEUSAS[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking file is named canonically. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/canonical_filename">com.google.fonts/check/canonical_filename</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenDEUSAS[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1361, but got 1328 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 626, but got 413 instead [code: descent]
...
>
* 🔥 **FAIL** OS/2 sTypoAscender (1291) and hhea ascent (1275) must be equal. [code: ascender]
...
post.italicAngle: 14.0
angle calculated from outlines: -14.3) [code: positive]
...
Got: caretSlopeRise 778 and caretSlopeRun 253
Expected: caretSlopeRise 1000 and caretSlopeRun -249 [code: caretslope-mismatch]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenDEUSAS-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0>

	- Contour 0 start point differs in glyph 'cnct.cnt_G_z' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd72b0> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x113fd7fa0> [code: interpolation-issues]

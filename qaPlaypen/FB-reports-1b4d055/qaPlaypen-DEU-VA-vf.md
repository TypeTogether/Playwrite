...
<details><summary><b>[19] PlaypenDEUVA[wght].ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Checking file is named canonically. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/canonical_filename">com.google.fonts/check/canonical_filename</a>)</summary><div>
...
>
* 🔥 **FAIL** Expected "Playpen[wght].ttf. Got PlaypenDEUVA[wght].ttf. [code: bad-filename]
...
>
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1452, but got 1434 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 626, but got 503 instead [code: descent]
...
>
* 🔥 **FAIL** OS/2 sTypoAscender (1402) and hhea ascent (1275) must be equal. [code: ascender]
...
angle calculated from outlines: -10.3) [code: positive]
...
Got: caretSlopeRise 556 and caretSlopeRun 181
Expected: caretSlopeRise 1000 and caretSlopeRun -176 [code: caretslope-mismatch]
...
* 🔥 **FAIL** 'Regular' instance has the same coordinates as the default instance; its postscript name should be 'Playpen-Rg00ShortSlow', instead of 'PlaypenDEUVA-Regular'. [code: invalid-default-instance-postscript-name]
...
>
* ⚠ **WARN** Interpolation issues were found in the font: 	- Contour 0 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 1 start point differs in glyph 'x.cnt_de.med' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 0 start point differs in glyph 'cnct.cnt_G_z' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 0 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 1 start point differs in glyph 'x.cnt_de.fin' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 0 start point differs in glyph 'cnct.mlp_b_z.mod' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 0 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0>

	- Contour 1 start point differs in glyph 'x.cnt_de.ini' between location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53f940> and location <fontTools.ttLib.ttGlyphSet._TTGlyphSetGlyf object at 0x10e53edd0> [code: interpolation-issues]
...
* ⚠ **WARN** OS/2 xAvgCharWidth is 647 but it should be 669 which corresponds to the average of the widths of all glyphs in the font. [code: xAvgCharWidth-wrong]
